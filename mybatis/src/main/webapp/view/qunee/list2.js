$(function() {
	...
	/**
	 * This file is part of Qunee for HTML5. Copyright (c) 2016 by qunee.com
	 */
	...
	Equipment.prototype = {
		...
		layoutChildren : function() {
			...
			this.forEachChild(function(child) {
				...
				if (isNaN(childRow) && isNaN(childColumn)
						&& Q.isNumber(child.index)) {
				...
				this.setChildBounds(child, startX + childColumn * cellWidth,
						startY + childRow * cellHeight, cellWidth * columnSpan,
						cellHeight * rowSpan);
			}, this)
		},
		/**
		 * 2 X 3, child node index 0, 1, 2 3, 4, 5
		 * 
		 * @param index
		 * @param info
		 * @returns {Equipment}
