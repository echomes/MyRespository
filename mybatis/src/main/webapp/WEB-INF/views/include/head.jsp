...
<script src="${ctx}/static/jquery/jquery-3.3.1.min.js" type="text/javascript"></script>
...
<link href="${ctx}/static/jquery-jbox/2.3/Skins/Bootstrap/jbox.min.css" rel="stylesheet" />
...
<script src="${ctx}/static/common/js.js" type="text/javascript"></script>
